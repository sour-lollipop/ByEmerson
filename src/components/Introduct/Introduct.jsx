  ...
  return (
    <Container id="Introduct">
      ...
      <Slide direction="left" >
        <Blok >
          <h4>Мы верим, что отдых должен быть не только увлекательным, но и доступным. Приглашаем вас отправиться в увлекательное путешествие с нами и насладиться беззаботным отдыхом по лучшим ценам на рынке. Ваша мечта – наша миссия</h4>
        </Blok>
      </Slide>
       <Bloks> 
