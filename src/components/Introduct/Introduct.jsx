...
const Introduct = () => {
  return (
    <Container id="Introduct">
      <h1>
          <span className="red">Путешествуйте</span> с нами
      </h1>
      <LineConteiner>
      <Slide direction="left" >
        <Blok >
          <h4>Мы верим, что отдых должен быть не только увлекательным, но и доступным. Приглашаем вас отправиться в увлекательное путешествие с нами и насладиться беззаботным отдыхом по лучшим ценам на рынке. <br/>Ваша мечта – наша миссия</h4>
        </Blok>
      </Slide>
       <Bloks> 
